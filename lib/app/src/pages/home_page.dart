...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Pikarito´as'),
        leading: const Icon(Icons.draw, size: 25.0),
        actions: [
          IconButton(
            icon: const Icon(Icons.save),
            tooltip: "Guardar en imagen",
  ...
  Widget _buildPointerModeSwitcher(BuildContext context,
    ...
    return FloatingActionButton.small(
      ...
      tooltip:
          ...
          "Cambia el modo de dibujo a " +
              (penMode ? "todos los punteros" : "solo pluma"),
